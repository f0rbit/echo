...
import { chaser_step_system, chaser_think_system } from "./systems/ai/chaser.ts";
...
export const game_plugin = (_w: World, sch: Schedule): void => {
	...
	sch.add("update", chaser_think_system, { every: ai_tick, name: "bst.ai_chaser_think" });
	sch.add("update", chaser_step_system, { every: step_every, name: "bst.ai_chaser_step" });
